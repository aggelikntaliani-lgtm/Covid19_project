...
Select location, date, total_cases, total_deaths, (total_deaths*1.0/total_cases)*100 as DeathPersentage
from PortfolioProject..CovidDeaths
where location like '%states%'
order by 1, 2

-- total cases vs population
-- shows what procentage got covid
Select location, date, total_cases, population, (total_cases*1.0/population)*100 as cases_in_population
from PortfolioProject..CovidDeaths
--where location like '%states%'
order by 1, 2
